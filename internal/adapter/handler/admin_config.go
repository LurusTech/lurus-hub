...
func AdminUpdateLoginConfig(c *gin.Context) {
	...
	if req.PasswordLoginEnabled != nil {
		if err := repo.UpdateOption("PasswordLoginEnabled", boolToString(*req.PasswordLoginEnabled)); err != nil {
			updateErrors = append(updateErrors, "PasswordLoginEnabled: "+err.Error())
		}
	}
	if req.PasswordRegisterEnabled != nil {
		if err := repo.UpdateOption("PasswordRegisterEnabled", boolToString(*req.PasswordRegisterEnabled)); err != nil {
			updateErrors = append(updateErrors, "PasswordRegisterEnabled: "+err.Error())
		}
	}
	if req.SMSEnabled != nil {
		if err := repo.UpdateOption("SMSEnabled", boolToString(*req.SMSEnabled)); err != nil {
			updateErrors = append(updateErrors, "SMSEnabled: "+err.Error())
		}
	}
	if req.SMSAutoRegister != nil {
		if err := repo.UpdateOption("SMSAutoRegister", boolToString(*req.SMSAutoRegister)); err != nil {
	...
	if req.PhoneVerificationMode != nil {
		if err := repo.UpdateOption("PhoneVerificationMode", *req.PhoneVerificationMode); err != nil {
			updateErrors = append(updateErrors, "PhoneVerificationMode: "+err.Error())
		}
	}
	if req.PhoneRequiredForLogin != nil {
		if err := repo.UpdateOption("PhoneRequiredForLogin", boolToString(*req.PhoneRequiredForLogin)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForLogin: "+err.Error())
		}
	}
	if req.PhoneRequiredForPasswordReset != nil {
		if err := repo.UpdateOption("PhoneRequiredForPasswordReset", boolToString(*req.PhoneRequiredForPasswordReset)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForPasswordReset: "+err.Error())
		}
	}
	if req.PhoneRequiredFor2FAChange != nil {
		if err := repo.UpdateOption("PhoneRequiredFor2FAChange", boolToString(*req.PhoneRequiredFor2FAChange)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredFor2FAChange: "+err.Error())
		}
	}
	if req.PhoneRequiredForPayment != nil {
		if err := repo.UpdateOption("PhoneRequiredForPayment", boolToString(*req.PhoneRequiredForPayment)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForPayment: "+err.Error())
		}
	}
	if req.PhoneRequiredForWithdrawal != nil {
		if err := repo.UpdateOption("PhoneRequiredForWithdrawal", boolToString(*req.PhoneRequiredForWithdrawal)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForWithdrawal: "+err.Error())
		}
	}
	if req.PhoneRequiredForPhoneBind != nil {
		if err := repo.UpdateOption("PhoneRequiredForPhoneBind", boolToString(*req.PhoneRequiredForPhoneBind)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForPhoneBind: "+err.Error())
		}
	}
	if req.PhoneRequiredForAccountDelete != nil {
		if err := repo.UpdateOption("PhoneRequiredForAccountDelete", boolToString(*req.PhoneRequiredForAccountDelete)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForAccountDelete: "+err.Error())
		}
	}
	if req.PhoneRequiredForTokenGenerate != nil {
		if err := repo.UpdateOption("PhoneRequiredForTokenGenerate", boolToString(*req.PhoneRequiredForTokenGenerate)); err != nil {
			updateErrors = append(updateErrors, "PhoneRequiredForTokenGenerate: "+err.Error())
		}
	}
	if req.PhoneRequiredForOAuthBind != nil {
		if err := repo.UpdateOption("PhoneRequiredForOAuthBind", boolToString(*req.PhoneRequiredForOAuthBind)); err != nil {
	...
	if req.RegistrationMode != nil {
		if err := repo.UpdateOption("RegistrationMode", *req.RegistrationMode); err != nil {
			updateErrors = append(updateErrors, "RegistrationMode: "+err.Error())
		}
	}
	if req.RegisterEnabled != nil {
		if err := repo.UpdateOption("RegisterEnabled", boolToString(*req.RegisterEnabled)); err != nil {
			updateErrors = append(updateErrors, "RegisterEnabled: "+err.Error())
		}
	}
	if req.EmailVerificationEnabled != nil {
		if err := repo.UpdateOption("EmailVerificationEnabled", boolToString(*req.EmailVerificationEnabled)); err != nil {
			updateErrors = append(updateErrors, "EmailVerificationEnabled: "+err.Error())
		}
	}
	if req.InviteCodeRequired != nil {
		if err := repo.UpdateOption("InviteCodeRequired", boolToString(*req.InviteCodeRequired)); err != nil {
	...
	if req.SensitiveActionRequirePassword != nil {
		if err := repo.UpdateOption("SensitiveActionRequirePassword", boolToString(*req.SensitiveActionRequirePassword)); err != nil {
			updateErrors = append(updateErrors, "SensitiveActionRequirePassword: "+err.Error())
		}
	}
	if req.SensitiveActionRequire2FA != nil {
		if err := repo.UpdateOption("SensitiveActionRequire2FA", boolToString(*req.SensitiveActionRequire2FA)); err != nil {
			updateErrors = append(updateErrors, "SensitiveActionRequire2FA: "+err.Error())
		}
	}
	if req.SessionTimeoutMinutes != nil {
		if err := repo.UpdateOption("SessionTimeoutMinutes", intToString(*req.SessionTimeoutMinutes)); err != nil {
