...
func TestScopeConstants(t *testing.T) {
	expectedScopes := []string{
		repo.ScopeUserRead,
		repo.ScopeUserWrite,
		repo.ScopeSubscriptionRead,
		repo.ScopeSubscriptionWrite,
		repo.ScopeQuotaRead,
		repo.ScopeQuotaWrite,
		repo.ScopeBalanceRead,
		repo.ScopeBalanceWrite,
		repo.ScopeAll,
	}
	...
	// Verify scope values
	if repo.ScopeAll != "*" {
		t.Errorf("ScopeAll should be '*', got %q", repo.ScopeAll)
	}
}
