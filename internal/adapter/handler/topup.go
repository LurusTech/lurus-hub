...
func RequestEpay(c *gin.Context) {
	...
	id := c.GetInt("id")
	group, err := repo.GetUserGroup(id, true)
	if err != nil {
...
func GetUserTopUps(c *gin.Context) {
	...
	if keyword != "" {
		topups, total, err = repo.SearchUserTopUps(userId, keyword, pageInfo)
	} else {
		topups, total, err = repo.GetUserTopUps(userId, pageInfo)
	}
	if err != nil {
...
func GetAllTopUps(c *gin.Context) {
	...
	if keyword != "" {
		topups, total, err = repo.SearchAllTopUps(keyword, pageInfo)
	} else {
		topups, total, err = repo.GetAllTopUps(pageInfo)
	}
	if err != nil {
		common.ApiError(c, err)
		return
