...
func getModelRequest(c *gin.Context) (*ModelRequest, bool, error) {
	...
	if strings.Contains(c.Request.URL.Path, "/mj/") {
		...
		if relayMode == relayconstant.RelayModeSunoFetch ||
			...
			modelName := app.CoverTaskActionToModelName(constant.TaskPlatformSuno, c.Param("action"))
...
func SetupContextForSelectedChannel(c *gin.Context, channel *repo.Channel, modelName string) *types.NewAPIError {
