...
import (
	...
	"github.com/LurusTech/lurus-api/internal/adapter/provider/ai360"
	"github.com/LurusTech/lurus-api/internal/adapter/provider/lingyiwanwu"

	//"github.com/LurusTech/lurus-api/internal/adapter/provider/minimax"
	"github.com/LurusTech/lurus-api/internal/adapter/provider/openrouter"
	"github.com/LurusTech/lurus-api/internal/adapter/provider/xinference"
	relaycommon "github.com/LurusTech/lurus-api/internal/adapter/provider/common"
	"github.com/LurusTech/lurus-api/internal/app/relay/common_handler"
...
func (a *Adaptor) ConvertGeminiRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeminiChatRequest) (any, error) {
	// 使用 app.GeminiToOpenAIRequest 转换请求格式
	openaiRequest, err := app.GeminiToOpenAIRequest(request, info)
	if err != nil {
		return nil, err
	}
...
func (a *Adaptor) ConvertClaudeRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.ClaudeRequest) (any, error) {
	...
	//	}
	//}
	aiRequest, err := app.ClaudeToOpenAIRequest(*request, info)
	if err != nil {
		return nil, err
	}
	//if common.DebugEnabled {
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	provider.SetupApiRequestHeader(info, c, header)
