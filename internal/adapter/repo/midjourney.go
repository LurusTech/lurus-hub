...
type Midjourney = entity.Midjourney
type TaskQueryParams = entity.TaskQueryParams
...
func MjInsert(midjourney *Midjourney) error {
	return DB.Create(midjourney).Error
}

func MjUpdate(midjourney *Midjourney) error {
