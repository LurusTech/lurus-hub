...
// Subscription is a type alias for entity.Subscription (canonical definition in domain/entity/subscription.go)
type Subscription = entity.Subscription

// Re-export subscription status constants from entity
const (
	SubscriptionStatusPending   = entity.SubscriptionStatusPending
	SubscriptionStatusActive    = entity.SubscriptionStatusActive
	SubscriptionStatusExpired   = entity.SubscriptionStatusExpired
	SubscriptionStatusCancelled = entity.SubscriptionStatusCancelled
)
