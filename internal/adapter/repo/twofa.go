...
// ErrTwoFANotEnabled is re-exported from the canonical definition in domain/entity/twofa.go
var ErrTwoFANotEnabled = entity.ErrTwoFANotEnabled

// Canonical definition: domain/entity/twofa.go
// TwoFA 用户2FA设置表
type TwoFA struct {
