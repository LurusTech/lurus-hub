...
type WebAuthnUser struct {
	user       *repo.User
	credential *repo.PasskeyCredential
}

func NewWebAuthnUser(user *repo.User, credential *repo.PasskeyCredential) *WebAuthnUser {
...
func (u *WebAuthnUser) ModelUser() *repo.User {
	if u == nil {
		return nil
	}
	return u.user
...
func (u *WebAuthnUser) PasskeyCredential() *repo.PasskeyCredential {
	if u == nil {
		return nil
	}
	return u.credential
