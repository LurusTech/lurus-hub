...
func CanEnableToken(token *model.Token) error {
...
func BuildCleanToken(userId int, tenantId string, token *model.Token, key string) model.Token {
	return model.Token{
		UserId:             userId,
		TenantId:           tenantId,
		Name:               token.Name,
...
func ApplyTokenUpdate(target *model.Token, source *model.Token) {
