...
func TestSubscribeV2_AlreadySubscribed(t *testing.T) {
	...
	SeedV2Subscription(t, ctx, ctx.NormalUser.Id, model.SubscriptionStatusActive)
...
func TestSubscribeV2_Success(t *testing.T) {
	...
	if data["status"].(string) != model.SubscriptionStatusPending {
		t.Errorf("expected status=pending, got %v", data["status"])
	}
}
...
func TestCancelSubscriptionV2_NotOwned(t *testing.T) {
	...
	sub := SeedV2Subscription(t, ctx, ctx.AdminUser.Id, model.SubscriptionStatusActive)
...
func TestCancelSubscriptionV2_NotActive(t *testing.T) {
	...
	sub := SeedV2Subscription(t, ctx, ctx.NormalUser.Id, model.SubscriptionStatusPending)
...
func TestCancelSubscriptionV2_Success(t *testing.T) {
	...
	// Create an active subscription
	sub := SeedV2Subscription(t, ctx, ctx.NormalUser.Id, model.SubscriptionStatusActive)
...
func TestGetSubscriptionsV2_Success(t *testing.T) {
	...
	SeedV2Subscription(t, ctx, ctx.NormalUser.Id, model.SubscriptionStatusActive)
	SeedV2Subscription(t, ctx, ctx.NormalUser.Id, model.SubscriptionStatusExpired)
